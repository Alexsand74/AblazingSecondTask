...
public class RunnerEx2 {
    public static void start() {
        ...
        ArrayList<Integer> january = new ArrayList<>(List.of(0, -1, -1, -2, -5, -6, -7, -8, -9, -10,
        ...
        Double averageDailyAirTemp = (double) sumTemperaturesAllDays(januaryAndFebruary) / januaryAndFebruary.size();
